...
\begin{align*}
    ...
    \sum_{j=1}^{4} x_{1jk} + \sum_{j=1}^{4} x_{2jk} + \sum_{j=1}^{4} x_{3jk} \leq 1 + 2 \cdot \max_{j} \left(\sum_{i=1}^{3} x_{ijk}\right) \quad \forall k \\
