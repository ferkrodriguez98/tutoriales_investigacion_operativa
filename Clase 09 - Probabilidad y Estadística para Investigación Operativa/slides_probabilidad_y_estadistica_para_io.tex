...
\begin{frame}{Fallas - Binomial Negativa}
    \textbf{Problema:}
    ...
    \textbf{Modelo:}
    \begin{itemize}
        \item $X \sim \text{Binomial Negativa}(10, 0.95)$
        \item Calcular $P(X \leq 2)$ (máximo 2 fallas antes del éxito 10)
    \end{itemize}
\end{frame}

\begin{frame}{Fallas - Solución}
...
\begin{frame}[fragile]{Fallas - Python}
    \begin{lstlisting}
